            ...
            return orders
              .map(function (order) {
                return '\n                <tr>\n                <td class="border px-4 py-2 text-green-900">\n                    <p>'
                  ...
                  .concat(
                    order.status === 'preparation' ? 'selected' : '',
      ...
      /***/ (
        ...
        function decreaseItemCartQty(product) {
          axios__WEBPACK_IMPORTED_MODULE_0___default()
            ...
            .then(function (res) {
              var productQty = document.getElementById(
                'productQty' + res.data.itemId
              );
              var productItemTotal = document.getElementById(
