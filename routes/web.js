...
function initRoutes(app) {
  ...
  app.put('/decrease-item-cart', cartController().decreaseItemQty);
  app.put('/increase-item-cart', cartController().increaseItemQty);
  // Customer routes
  ...
  app.get('/admin/clients/updateUser', clientController().handleUser);
